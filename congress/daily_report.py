...
def main() -> int:
    ...
    try:
        ...
        # The dated copy + archive index. Same payload as report.json so the
        # permalink and the email can never disagree about what went out.
        ...
        entry = {"date": today_iso,
                 "dateLabel": report["payload"]["dateLabel"],
