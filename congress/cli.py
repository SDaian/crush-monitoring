...
def _cmd_prices(args: argparse.Namespace) -> int:
    ...
    payload = {
        "meta": {
            "_comment": (
                "Estimated stock performance since each disclosed BUY, from "
                "Stooq daily closes. NOT a member's realized profit — holding "
                "period, later sells, dividends and position size are unknown, "
                "and entry uses the trade date's close, not the fill price. "
                "Generated by congress/prices.py; do not edit by hand."
            ),
